...
class ApolloCrew < ApolloDataTable
  ...
  def write_commander(triples, mission_name, mission_id, mission)
    ...
    write_role(triples, mission_name, mission_id, role_uri, "http://nasa.dataincubator.org/roles/mission-commander", label, mission["Commander"], actor_name)
    write_role(triples, mission_name, mission_id, backup_role_uri, "http://nasa.dataincubator.org/roles/backup-mission-commander", backup_label, nil, mission["Commander"]["Backup"])
  end  
  ...
  def write_cm_pilot(triples, mission_name, mission_id, mission)
    ...
    write_role(triples, mission_name, mission_id, role_uri, "http://nasa.dataincubator.org/roles/command-module-pilot", label, mission["Command Module Pilot"], actor_name)
    write_role(triples, mission_name, mission_id, backup_role_uri, "http://nasa.dataincubator.org/roles/backup-command-module-pilot", backup_label, nil, mission["Command Module Pilot"]["Backup"])
  end  
  ...
  def write_lm_pilot(triples, mission_name, mission_id, mission)
    ...
    write_role(triples, mission_name, mission_id, role_uri, "http://nasa.dataincubator.org/roles/lunar-module-pilot", label, mission["Lunar Module Pilot"], actor_name)
    write_role(triples, mission_name, mission_id, backup_role_uri, "http://nasa.dataincubator.org/roles/backup-lunar-module-pilot", backup_label, nil, mission["Lunar Module Pilot"]["Backup"])
  end  
