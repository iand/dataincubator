...
class Image
    ...
    def to_rdf(root=true)
      ...
      triples << "  <foaf:depicts rdf:resource=\"http://nasa.dataincubator.org/spacecraft/#{@designator}\"/>\n"
      triples << "</foaf:Image>"
      triples << "\n"
      
      triples << "<rdf:Description rdf:about=\"http://nasa.dataincubator.org/spacecraft/#{@designator}\">" 
...
class LaunchSite
  def initialize(launchsite)
      ...
      @id = "http://nasa.dataincubator.org/launchsite/#{normalized_placename}"
...
class Launch
  ...
  def to_rdf(root=true)
    ...
    triples << "  <space:spacecraft rdf:resource=\"http://nasa.dataincubator.org/spacecraft/#{@designator}\"/>\n"
...
class Discipline
    def initialize(discipline)
      @label = discipline
      @id = "http://nasa.dataincubator.org/discipline/#{Util.normalize( discipline )}"
    end  
...
class NSSDCSpacecraft
  ...
  def to_rdf(root=true)
    ...
    triples << "<space:Spacecraft rdf:about=\"http://nasa.dataincubator.org/spacecraft/#{@id}\">\n"
